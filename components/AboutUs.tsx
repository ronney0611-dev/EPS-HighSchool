    ...
    return (
        ...
        <div dir='rtl' className="w-full bg-black items-center text-white font-sans antialiased dir-rtl min-h-screen">
            ...
            <section className={`${SECTION_CONTAINER_CLASS} text-center`}>
                <div className="bg-neutral-950 p-12 md:p-20 -m-12 rounded-[2rem] border border-neutral-800 shadow-inner flex flex-col items-center">
                    <p className="text-xl text-white max-w-2xl mx-auto mb-12 leading-relaxed">
                        نحن نقدر رأيك! إذا كان لديك أي استفسار، اقتراح للتطوير، أو تحتاج إلى دعم فني، فلا تتردد في الاتصال بنا مباشرة. رأيكم يهمنا لبناء مستقبل أفضل لمادة التربية البدنية والرياضية.
                    </p>
